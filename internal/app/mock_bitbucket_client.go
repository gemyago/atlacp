...
func (_m *MockbitbucketClient) RequestPRChanges(ctx context.Context, tokenProvider bitbucket.TokenProvider, params bitbucket.RequestPRChangesParams) (string, error) {
	ret := _m.Called(ctx, tokenProvider, params)
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, bitbucket.TokenProvider, bitbucket.RequestPRChangesParams) (string, error)); ok {
		return rf(ctx, tokenProvider, params)
	}
	...
	if rf, ok := ret.Get(1).(func(context.Context, bitbucket.TokenProvider, bitbucket.RequestPRChangesParams) error); ok {
		r1 = rf(ctx, tokenProvider, params)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockbitbucketClient_RequestPRChanges_Call) Return(_a0 string, _a1 error) *MockbitbucketClient_RequestPRChanges_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockbitbucketClient_RequestPRChanges_Call) RunAndReturn(run func(context.Context, bitbucket.TokenProvider, bitbucket.RequestPRChangesParams) (string, error)) *MockbitbucketClient_RequestPRChanges_Call {
	_c.Call.Return(run)
	return _c
}
