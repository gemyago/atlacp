...
// ResolvePRComment provides a mock function with given fields: ctx, tokenProvider, params
func (_m *MockbitbucketClient) ResolvePRComment(ctx context.Context, tokenProvider bitbucket.TokenProvider, params bitbucket.ResolvePRCommentParams) (*bitbucket.CommentResolution, error) {
	ret := _m.Called(ctx, tokenProvider, params)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, bitbucket.TokenProvider, bitbucket.ResolvePRCommentParams) (*bitbucket.CommentResolution, error)); ok {
		return rf(ctx, tokenProvider, params)
	}
	if rf, ok := ret.Get(0).(func(context.Context, bitbucket.TokenProvider, bitbucket.ResolvePRCommentParams) *bitbucket.CommentResolution); ok {
		r0 = rf(ctx, tokenProvider, params)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, bitbucket.TokenProvider, bitbucket.ResolvePRCommentParams) error); ok {
		r1 = rf(ctx, tokenProvider, params)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockbitbucketClient_ResolvePRComment_Call) Run(run func(ctx context.Context, tokenProvider bitbucket.TokenProvider, params bitbucket.ResolvePRCommentParams)) *MockbitbucketClient_ResolvePRComment_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(bitbucket.TokenProvider), args[2].(bitbucket.ResolvePRCommentParams))
	})
	return _c
}

func (_c *MockbitbucketClient_ResolvePRComment_Call) Return(_a0 *bitbucket.CommentResolution, _a1 error) *MockbitbucketClient_ResolvePRComment_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockbitbucketClient_ResolvePRComment_Call) RunAndReturn(run func(context.Context, bitbucket.TokenProvider, bitbucket.ResolvePRCommentParams) (*bitbucket.CommentResolution, error)) *MockbitbucketClient_ResolvePRComment_Call {
	_c.Call.Return(run)
	return _c
}
